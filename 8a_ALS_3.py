...
def train_and_eval(spark, userID, file_paths, r, lambdaReg, a, utility_train, utility_val, selected_val):
    ...
    als = ALS(maxIter = 20, regParam = lambdaReg, rank = r, alpha = a, userCol = 'user_id', itemCol = 'song_id', \
...
def main(spark, userID):
    ...
    file_names = ['utility_train_filtered', 'utility_val_filtered', 'selected_val', 'utility_test']
...
if __name__ == "__main__":
    ...
    spark = SparkSession.builder.appName('ALS_full').getOrCreate()
